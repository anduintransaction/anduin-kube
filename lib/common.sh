...
export MINIKUBE_ISO_VERSION=v0.20.0
...
export KUBERNETES_VERSION=v1.6.3
export KUBERNETES_MINIKUBE_VERSION=v1.6.3
export DOCKER_VERSION=1.12.4
export IMLADRIS_VERSION=0.10.6
export COREDNS_VERSION=007
