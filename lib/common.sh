...
export MINIKUBE_VERSION=v0.25.2
export MINIKUBE_ISO_VERSION=v0.26.0
...
export MINIKUBE_RAM=${MINIKUBE_RAM:-4096}
export MINIKUBE_DISK_SIZE=50g
export KUBERNETES_VERSION=v1.10.5
export KUBERNETES_MINIKUBE_VERSION=v1.9.4
export DOCKER_VERSION=18.03.0-ce
export IMLADRIS_VERSION=0.13.1
export COREDNS_VERSION=1.1.1
